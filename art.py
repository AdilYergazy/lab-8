...
def main(triangle, circle, rectangle):
    pygame.init()
...
def drawLineBetween(screen, index, start, end, width, color_mode, triangle, circle, rectangle):
...
main(triangle=False, circle=True, rectangle=False)
