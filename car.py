...
all_sprites.add(P1)
all_sprites.add(E1)
# Adding the coin sprite to the sprite groups
...
while True:
    ...
    # Display coin count
    coin_counter = font_small.render(f"Coins: {coin_count}", True, BLACK)
    DISPLAYSURF.blit(coin_counter, (10, 30))
