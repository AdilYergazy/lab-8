...
class Snake:
    ...
    def check_collision(self):
        head = self.body[0]
        return head in self.body[1:] or head[0] < 0 or head[0] >= SCREEN_WIDTH // CELL_SIZE or head[1] < 0 or head[1] >= SCREEN_HEIGHT // CELL_SIZE
...
while True:
    ...
    for segment in snake.body:
        pygame.draw.rect(screen, BLACK, pygame.Rect(segment[0] * CELL_SIZE, segment[1] * CELL_SIZE, CELL_SIZE, CELL_SIZE))
